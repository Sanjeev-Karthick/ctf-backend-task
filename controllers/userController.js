...
exports.signup = async (req,res,next)=>{
    ...
    if(existingUser){
        ...
        await Mailer.emailer(`Registration verification`, `Please click this verification link to complete the registeration process `+ `<a href="http://localhost:4000/api/v1/verify?verificationString=${user.verificationString}"\>Verify</a>`, user);
